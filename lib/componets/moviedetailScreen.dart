...
}  i want to you to give e the correct code to show  related movies posture  in the scroll image part of this screen by using when this page first rendered it will fetch movies by the movies  first three letter of titel and display there posture by using this api 'http://www.omdbapi.com/?apikey=$apiKey&t=$firstthreelettersoftitel' ,give me the full code  */